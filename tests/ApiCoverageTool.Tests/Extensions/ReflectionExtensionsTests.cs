...
public class ReflectionExtensionsTests
{
    ...
    [Fact]
    public void ToMethodBase_ForNullParameter_ThrowsArgumentNullException()
    {
        MethodDefinition methodDefinition = null;
        Assert.Throws<ArgumentNullException>(() => methodDefinition.ToMethodBase());
    }

    [Fact]
    public void ToMethodBase_ForMethodDefinition_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
        ...
        var actualMethodInfo = methodDefinition.ToMethodBase();

        actualMethodInfo.Should().BeSameAs(expectedMethod);
    }

    [Fact]
    public void ToMethodBase_ForMethodWithParameters_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
    ...
    [Fact]
    public void ToMethodBase_ForAsyncMethod_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
    ...
    [Fact]
    public void ToMethodBase_ForGenericMethod_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
    ...
    [Fact]
    public void ToMethodBase_ForOverridenMethod_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
    ...
    [Fact]
    public void ToMethodBase_ForPrivateMethod_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
    ...
    [Fact]
    public void ToMethodBase_ForInternalMethod_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
    ...
    [Fact]
    public void ToMethodBase_ForPrivateStaticMethod_ReturnsMethodInfoForSpecifiedMethod()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var type = typeof(TestClass);
