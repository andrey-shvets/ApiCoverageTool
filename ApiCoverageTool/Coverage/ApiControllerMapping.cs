...
namespace ApiCoverageTool.Coverage
{
    ...
    {
        public static async Task<MappedApiResult> GetMappingByControllerFromUri(Uri swaggerJsonUri, params Type[] controllers)
        {
        ...
        public static async Task<MappedApiResult> GetMappingByControllerFromUri(string swaggerJsonUri, params Type[] controllers)
        {
        ...
        public static MappedApiResult GetMappingByControllerFromFile(string swaggerJsonPath, params Type[] controllers)
        {
        ...
        public static MappedApiResult GetMappingByController(string swaggerJson, params Type[] controllers)
        {
        ...
        public static MappedApiResult GetMappingByController(IList<EndpointInfo> serviceEndpoints,
